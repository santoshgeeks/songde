...
export class PromotionToolComponent implements OnInit {
  cardsData = [
    ...
    {
      icon: "../../assets/icons/cardicon/Toggle.svg",
    ...
    {
      icon: "../../assets/icons/cardicon/Wifi.svg",
    ...
    {
      icon: "../../assets/icons/cardicon/Fitv.svg",
    ...
    {
      icon: "../../assets/icons/cardicon/Comment.svg",
